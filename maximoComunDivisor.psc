...
Algoritmo maximoComunDivisor
	//definir e incializar vaiables 
	definir minComunDiv ,num1, num2 Como Entero
	num1 = 0
	minComunDiv = 0
	num2 = 0
	...
	//llamar función 
	minComunDiv = MCD(num1, num2)
	
	//imprimir resultado
	Escribir 'El máximo común divisor de ', num1, ' y ', num2, ' es: ', minComunDiv
